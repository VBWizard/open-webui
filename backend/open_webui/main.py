...
app.state.config.ENABLE_QUERY_REWRITING = ENABLE_QUERY_REWRITING
app.state.config.QUERY_REWRITING_MODEL = QUERY_REWRITING_MODEL
app.state.config.QUERY_REWRITING_PROMPT_TEMPLATE = QUERY_REWRITING_PROMPT_TEMPLATE
app.state.config.MEMCHAT_EMBED_CONNECTION_IDX = MEMCHAT_EMBED_CONNECTION_IDX
app.state.config.MEMCHAT_EMBED_MODEL = MEMCHAT_EMBED_MODEL
